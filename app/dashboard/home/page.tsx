      ...
      <div className="relative overflow-hidden rounded-lg border bg-gradient-to-r from-primary/5 via-primary/10 to-primary/5 p-6">
        ...
        <div className="relative">
          ...
          <p className="text-muted-foreground mb-4">
            Here&apos;s what&apos;s happening with your SaaS today. Your dashboard is ready to help you track progress and grow your business.
          </p>
          ...
          <CardContent>
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">Feature deployed</span>
