...
export default function UploadPage() {
  ...
  return (
    <>
      <DashboardPageHeader title="File Upload" />
          ...
          <TabsContent value="client" className="space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Upload images with automatic compression. Maximum 10MB per
                  file, up to 3 files.
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Upload multiple files at once. Any supported file type, up to
                  10 files.
                </CardDescription>
              </CardHeader>
              <CardContent>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="rounded-lg border border-blue-200 bg-blue-50 p-4">
                  ...
                  <ul className="space-y-1 text-sm text-blue-800">
                    ...
                    <li>
                      • Automatic file optimization and metadata extraction
                    </li>
