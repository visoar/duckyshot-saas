...
import { getConnectionConfig, getEnvironmentType, validateDatabaseConfig } from './config';
  ...
  describe('Database Connectivity', () => {
    ...
    it('should handle connection errors gracefully', async () => {
       ...
       try {
         ...
         expect((error as Error).message).toContain('relation "non_existent_table_12345" does not exist');
       }
     });
