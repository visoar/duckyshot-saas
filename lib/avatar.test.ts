...
describe('avatar utilities', () => {
  describe('generateAvatarUrl', () => {
    it('should generate correct avatar URL with default style', () => {
      ...
      expect(result).toBe('https://api.dicebear.com/9.x/adventurer-neutral/svg?seed=test%40example.com');
    });
    ...
    it('should generate correct avatar URL with custom style', () => {
      ...
      expect(result).toBe('https://api.dicebear.com/9.x/pixel-art/svg?seed=testuser');
    });
    ...
    it('should handle special characters in seed', () => {
      ...
      expect(result).toBe('https://api.dicebear.com/9.x/adventurer-neutral/svg?seed=user%2Btest%40domain.com');
    });
    ...
    it('should handle empty seed', () => {
      ...
      expect(result).toBe('https://api.dicebear.com/9.x/adventurer-neutral/svg?seed=');
    });
    ...
    it('should handle unicode characters', () => {
      ...
      expect(result).toBe('https://api.dicebear.com/9.x/adventurer-neutral/svg?seed=%E3%83%86%E3%82%B9%E3%83%88%E7%94%A8%E6%88%B7');
    });
  });
  ...
  describe('getUserAvatarUrl', () => {
    ...
    it('should generate avatar from name when no user image or email', () => {
      ...
      expect(result).toBe('https://api.dicebear.com/9.x/adventurer-neutral/svg?seed=Test%20User');
    });

    it('should use default "User" seed when no parameters provided', () => {
      const result = getUserAvatarUrl(null, null, null);
      
      expect(result).toBe('https://api.dicebear.com/9.x/adventurer-neutral/svg?seed=User');
    });
    ...
    it('should use custom style when provided', () => {
      ...
      expect(result).toBe('https://api.dicebear.com/9.x/avataaars/svg?seed=test%40example.com');
    });

    it('should handle undefined vs null correctly', () => {
      const result1 = getUserAvatarUrl(undefined, 'test@example.com', undefined);
      const result2 = getUserAvatarUrl(null, 'test@example.com', null);
      
      expect(result1).toBe(result2);
      expect(result1).toBe('https://api.dicebear.com/9.x/adventurer-neutral/svg?seed=test%40example.com');
    });
    ...
    it('should prioritize email over name for seed', () => {
      ...
      expect(result).toBe('https://api.dicebear.com/9.x/adventurer-neutral/svg?seed=priority%40example.com');
    });
    ...
    it('should handle whitespace-only strings as valid input', () => {
      const result = getUserAvatarUrl('   ', '  user@example.com  ', '  Test User  ');
    ...
    it('should handle whitespace-only email and name', () => {
      ...
      expect(result).toBe('https://api.dicebear.com/9.x/adventurer-neutral/svg?seed=%20%20%20'); // Should use the email
    });
  });
  ...
  describe('generateAvatarUrl edge cases', () => {
    it('should handle very long seeds', () => {
      ...
      expect(result).toContain('https://api.dicebear.com/9.x/adventurer-neutral/svg?seed=');
    ...
    it('should handle seeds with all special characters', () => {
      ...
      expect(result).toBe(`https://api.dicebear.com/9.x/adventurer-neutral/svg?seed=${encodeURIComponent(specialSeed)}`);
    });
    ...
    it('should handle seeds that need URL encoding', () => {
      ...
      expect(result).toBe(`https://api.dicebear.com/9.x/adventurer-neutral/svg?seed=${encodeURIComponent(encodingSeed)}`);
    });

    it('should handle different avatar styles', () => {
      const seed = 'test@example.com';
      const styles = ['pixel-art', 'avataaars', 'big-smile', 'bottts', 'identicon'];
      
      styles.forEach(style => {
        const result = generateAvatarUrl(seed, style);
        expect(result).toBe(`https://api.dicebear.com/9.x/${style}/svg?seed=${encodeURIComponent(seed)}`);
      });
    });
    ...
    it('should handle null and undefined seeds', () => {
      ...
      expect(nullResult).toBe('https://api.dicebear.com/9.x/adventurer-neutral/svg?seed=null');
      expect(undefinedResult).toBe('https://api.dicebear.com/9.x/adventurer-neutral/svg?seed=undefined');
    });
    ...
    it('should handle numeric seeds', () => {
      ...
      expect(result).toBe('https://api.dicebear.com/9.x/adventurer-neutral/svg?seed=12345');
    });
  });
  ...
  describe('getUserAvatarUrl comprehensive edge cases', () => {
    ...
    it('should handle mixed null and undefined values', () => {
      ...
      expect(result1).toBe('https://api.dicebear.com/9.x/adventurer-neutral/svg?seed=Test%20User');
      expect(result2).toBe('https://api.dicebear.com/9.x/adventurer-neutral/svg?seed=Test%20User');
    });

    it('should prioritize user image over any other values', () => {
      const userImage = 'https://example.com/avatar.jpg';
      const result = getUserAvatarUrl(userImage, 'email@example.com', 'Test User', 'custom-style');
    ...
    it('should handle boolean values as seeds', () => {
      ...
      expect(result1).toBe('https://api.dicebear.com/9.x/adventurer-neutral/svg?seed=true');
      expect(result2).toBe('https://api.dicebear.com/9.x/adventurer-neutral/svg?seed=User');
    });
    ...
    it('should handle object values as seeds', () => {
      ...
      expect(result).toBe('https://api.dicebear.com/9.x/adventurer-neutral/svg?seed=custom-string');
    });
    ...
    it('should handle style parameter edge cases', () => {
      ...
      const result3 = getUserAvatarUrl(null, 'test@example.com', null, undefined);
      
      expect(result1).toBe('https://api.dicebear.com/9.x//svg?seed=test%40example.com');
      expect(result2).toBe('https://api.dicebear.com/9.x/null/svg?seed=test%40example.com');
      // undefined defaults to AVATAR_STYLE
      expect(result3).toBe('https://api.dicebear.com/9.x/adventurer-neutral/svg?seed=test%40example.com');
    });
  ...
  describe('URL encoding verification', () => {
    it('should properly encode complex email addresses', () => {
      ...
      expect(result).toBe(`https://api.dicebear.com/9.x/adventurer-neutral/svg?seed=${encodeURIComponent(complexEmail)}`);
      expect(result).toContain('user%2Btest.name%40sub-domain.example-site.co.uk');
    });
    ...
    it('should properly encode names with international characters', () => {
      ...
      expect(result).toBe(`https://api.dicebear.com/9.x/adventurer-neutral/svg?seed=${encodeURIComponent(internationalName)}`);
    });
  });
});