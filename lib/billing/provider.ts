...
export interface PaymentProvider {
    createCheckoutSession(options: CreateCheckoutOptions): Promise<{ checkoutUrl: string }>;
     ...
     */
    handleWebhook(payload: string, signature: string): Promise<{ received: boolean; message?: string }>;
}