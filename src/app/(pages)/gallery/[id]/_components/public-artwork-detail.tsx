...
interface PublicArtworkDetailProps {
  artworkId: string;
}

export function PublicArtworkDetail({ artworkId }: PublicArtworkDetailProps) {
  ...
  useEffect(() => {
    async function loadArtwork() {
      try {
        ...
        const response = await fetch(`/api/ai/artworks/public/${artworkId}`);
            ...
            {artwork.status === "completed" && artwork.generatedImages && (
              <>
                <Button
                  ...
                  size="sm"
                  onClick={() =>
                    handleDownload(artwork.generatedImages![selectedImageIndex])
                  }
                >
            ...
            <Card className="border-blue-200 bg-gradient-to-r from-blue-50 to-purple-50">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-muted-foreground mb-4 text-sm">
                  Get inspired and create beautiful AI artworks of your own pets
                </p>
                <Button asChild>
                  <Link href="/ai-studio">
