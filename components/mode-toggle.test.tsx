...
describe('ModeToggle Component', () => {
  ...
  it('should display correct icon for light theme', async () => {
    ...
    await waitFor(() => {
      const button = screen.getByRole('button');
      expect(button).toHaveAttribute('title', 'Current theme: Light. Click to cycle themes.');
    });
  });
  ...
  it('should display correct icon for dark theme', async () => {
    ...
    await waitFor(() => {
      const button = screen.getByRole('button');
      expect(button).toHaveAttribute('title', 'Current theme: Dark. Click to cycle themes.');
    });
  });
  ...
  it('should display correct icon for system theme', async () => {
    ...
    await waitFor(() => {
      const button = screen.getByRole('button');
      expect(button).toHaveAttribute('title', 'Current theme: System. Click to cycle themes.');
    });
  });
