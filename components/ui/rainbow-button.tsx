...
export function RainbowButton({
  ...
  return (
    <button
      className={cn(
        "group relative inline-flex h-9 animate-rainbow cursor-pointer items-center justify-center rounded-full border-0 bg-size-[200%] px-8 py-2 font-medium text-primary transition-colors [background-clip:padding-box,border-box,border-box] bg-origin-border [border:calc(0.08*1rem)_solid_transparent] focus-visible:outline-hidden focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
